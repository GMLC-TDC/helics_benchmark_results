...
def create_inter_run_id_report(output_path, json_results, run_id):
    ...
    report_name = run_id + '_benchmark_inter_run.pdf'
...
if __name__ == '__main__':
    ...
    fileHandle = logging.FileHandler("benchmark_inter_run_PDF.log", mode='w')
    ...
    # TDH (2020-01-13) - Create the PDF for a benchmark inter-run
    _auto_run(args)